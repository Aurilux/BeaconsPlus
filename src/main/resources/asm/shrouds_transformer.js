...
function initializeCoreMod() {
    return {
        'throwable_entity': {
            ...
            'transformer': injectNauseaInaccuracy
        },
        'abstract_arrow_entity': {
            'target': {
                'type': 'METHOD',
...
function injectNauseaInaccuracy(shoot) {
    log("Found shoot")
    ...
    newInstructions.add(new MethodInsnNode(Opcodes.INVOKESTATIC, "aurilux/shrouds/common/CommonEventHandler",
        "nauseaInaccuracy", "(Lnet/minecraft/entity/IProjectile;)F", false));
