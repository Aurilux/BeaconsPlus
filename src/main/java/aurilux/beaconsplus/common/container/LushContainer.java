...
public class LushContainer extends Container {
    private final IInventory tileLush = new Inventory(1) {
    ...
    private final LushSlot beaconSlot;
    private final IWorldPosCallable worldPos;
    private final IIntArray intArray;

    public LushContainer(int id, IInventory inventory) {
        this(id, inventory, new IntArray(3), IWorldPosCallable.DUMMY);
    }

    public LushContainer(int id, IInventory inventory, IIntArray array, IWorldPosCallable worldPos) {
        super(ModObjects.LUSH_CONTAINER.get(), id);
        assertIntArraySize(array, 3);
        this.intArray = array;
        this.worldPos = worldPos;
        this.beaconSlot = new LushContainer.LushSlot(this.tileLush, 0, 136, 110);
    ...
    public boolean canInteractWith(PlayerEntity playerIn) {
        return isWithinUsableDistance(this.worldPos, playerIn, ModObjects.LUSH_BLOCK.get());
    }
    ...
    public boolean isActive() {
        return !this.tileLush.getStackInSlot(0).isEmpty();
    }

    class LushSlot extends Slot {
        public LushSlot(IInventory inventoryIn, int index, int xIn, int yIn) {
